...
public final class StudentAnalytics {
    ...
    public double averageAgeOfEnrolledStudentsParallelStream(
        ...
        ageAverage = Arrays.stream(studentArray)
                .parallel()
    ...
    public String mostCommonFirstNameOfInactiveStudentsParallelStream(
        ...
        mostCommonFirstName = Arrays.stream(studentArray)
                .parallel()
                .filter(s -> !s.checkIsCurrent())
        ...
        //System.out.printf("\nmostCommonFirstName=%s", mostCommonFirstName);
    ...
    public int countNumberOfFailedStudentsOlderThan20ParallelStream(
        ...
        count = (int)Arrays.stream(studentArray)
                .parallel()
                .filter(s ->
                    !s.checkIsCurrent() && s.getAge() > 20 && s.getGrade() < 65
                ).count();
